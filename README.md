...
2. WEBSITE GOALS AND OBJECTIVES 
 ...
 The goal of our computer shop is to increase online sales by making it easy for our customers to browse and buy products, while building trust and reliability through clear information. We also aim to attract new customers nationwide and reach a wider audience beyond our physical store. The success of our website will be measured using the following KPIs:  

Ease of navigation: End users can easily move between pages using navigation links 

Product display: Products are clearly shown with correct prices and images 

Load speed: Pages load quickly with no errors  

Accuracy of information: All products and contact details are correct and up to date 

3. CURRENT WEBSITE ANALYSIS 

Our website has several strengths but also areas that need improvement. Our website has the following strengths:  
...
However, we intend on modernising our design and improving the end-to-end encryption 

4.  PROPOSED WEBSITE FEATURES AND FUNCTIONALITY 

Home Page 

Overview of business and offerings 
...
CSS will handle styling and responsive layout, while JavaScript will enable dynamic features like interactive menus and product filters. 

7. TIMELINE AND MILESTONES 

It will take 4 weeks for our website to fully function.  
...
WEEK 4: FINAL REVIEW AND HAND IN 

8. BUDGET 

The project development will roughly cost R 500- R 2000 

Hosting will cost R80- R300 PER MONTH 

Maintenance will cost R300-R800 PER MONTH 

9.REFERENCES 

   Google Maps (2024) https://www.amazon.com  

  Nielsen Norman Group. (n.d.). Usability Principles 
